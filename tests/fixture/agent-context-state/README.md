...
| `AGENTS.md` | Has a managed block **in the middle**, with writable prose above and below it |
| `docs/agent/CLAUDE.md` | A target at a **nested path**, proving entries are project-relative and need not sit at the root |
